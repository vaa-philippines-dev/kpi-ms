...
// Sourced from React Bits (https://reactbits.dev/components) — staged here for
// the final landing-page polish pass, not wired into any page yet.

import { useRef, useEffect } from "react";
import "./ShapeGrid.css";

type Direction = "up" | "right" | "down" | "left" | "diagonal";
